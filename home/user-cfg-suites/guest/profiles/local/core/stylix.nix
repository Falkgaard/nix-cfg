{ ... }:
{
   ...
   let
      ...
      base16_scheme_name = "da-one-paper";
      base16_scheme      = "${pkgs.base16-schemes}/share/themes/${base16_scheme}.yaml";
   ...
   stylix = {
      ...
      # Home targets: (TODO: Ensure they're set properly. Via `home-manager.users.«name».stylix`?)
      targets = {
